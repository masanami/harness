---
name: agent-memory
description: "Use this skill when the user asks to save, remember, recall, or organize memories. Triggers on: '$agent-memory', '記憶して', '覚えておいて', 'メモして', '思い出して', '○○について教えて', 'remember this', 'save this', 'recall'. Also use proactively when discovering valuable findings worth preserving."
---
...
**保存場所**: `.agents/skills/agent-memory/memories/`
...
rg "kintone" .agents/skills/agent-memory/memories/ --no-ignore --hidden
```
