...
| 用途 | 参照ファイル |
|------|------------|
| チケット作成 | `.agents/skills/create-ticket/SKILL.md` + テンプレート |
| 設計 | `.agents/skills/design/SKILL.md` + テンプレート |
| 新規機能実装 | `.codex/agents/implement-feature.toml` |
| 既存機能変更 | `.codex/agents/modify-feature.toml` |
| 品質チェック | `.agents/skills/quality-check/SKILL.md` |
| コミット | `.agents/skills/commit/SKILL.md` |
| レビュー対応 | `.agents/skills/pr-review-respond/SKILL.md` |
| マージ | `.agents/skills/pr-merge/SKILL.md` |
...
プロジェクトルートの `AGENTS.md` を読み、技術スタック・開発規約・開発原則を把握する。
...
`.agents/skills/create-ticket/SKILL.md` を読み込み、チケット作成の手順・テンプレートを把握する。以降のチケット作成はすべてこのスキルの手順に従うこと。
...
`.agents/skills/design/SKILL.md` を読み込み、設計の手順・テンプレートを把握する。
...
`.agents/skills/create-ticket/SKILL.md` を読み込み、チケット作成の手順・テンプレートを把握する。
...
- `AGENTS.md` — プロジェクト構成・規約・コマンド
- `.codex/agents/implement-feature.toml` — TDD実装手順
- `.agents/skills/quality-check/SKILL.md` — 品質チェック手順
- `.agents/skills/commit/SKILL.md` — コミット規約
...
以下のファイルを読み込み、各工程の手順を把握する:
- `AGENTS.md` — プロジェクト構成・規約
- `.agents/skills/pr-review-respond/SKILL.md` — レビュー対応手順
- `.agents/skills/pr-merge/SKILL.md` — マージ手順
